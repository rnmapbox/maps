...
fix(example): update `/example` project (iOS only) to work with ARM-based Macs, and set up Cocoapods to install in the project directory instead of globally ([#1643](https://github.com/react-native-mapbox-gl/maps/pull/1643))  
