...
| localizeLabels | `Locale` | `none` | `false` | [`mapbox` (v10) implementation only]<br/>Set map's label locale, e.g. { "locale": "es" } will localize labels to Spanish, { "locale": "current" } will localize labels to system locale. |
