<!-- Autogenerated from PointAnnotation. Do not modify. -->
## <MapboxGL.PointAnnotation />
### PointAnnotation represents a one-dimensional shape located at a single geographical coordinate.<br/><br/>Consider using ShapeSource and SymbolLayer instead, if you have many points and you have static images,<br/>they'll offer much better performance.<br/><br/>If you need interactive views, please use MarkerView, as with PointAnnotation on Android, child views<br/>are rendered onto a bitmap for better performance.
