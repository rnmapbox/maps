...
@implementation RNMBXRasterLayerComponentView {
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const RNMBXRasterLayerProps>();
    _props = defaultProps;
      [self prepareView];
  }
...
{
  return concreteComponentDescriptorProvider<RNMBXRasterLayerComponentDescriptor>();
}
...
Class<RCTComponentViewProtocol> RNMBXRasterLayerCls(void)
{
  return RNMBXRasterLayerComponentView.class;
}
