@objc(MBXShapeSourceViewManager)
public class MBXShapeSourceViewManager: RCTViewManager {
  @objc
  ...
  @objc override public func view() -> UIView {
    return MBXShapeSource()
  }
}
// MARK: - react methods

extension MBXShapeSourceViewManager {
  @objc public static func getClusterExpansionZoom(
    shapeSource: MBXShapeSource,
    featureJSON: String,
