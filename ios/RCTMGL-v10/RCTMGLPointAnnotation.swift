...
class RCTMGLPointAnnotation: RCTMGLInteractiveElement {
  ...
  weak var callout: RCTMGLCallout?
  var calloutId: String?
  var image: UIImage?
  var reactSubviews: [UIView] = []

  @objc var onDeselected: RCTBubblingEventBlock?
  @objc var onDrag: RCTBubblingEventBlock?
  @objc var onDragEnd: RCTBubblingEventBlock?
  @objc var onSelected: RCTBubblingEventBlock?
