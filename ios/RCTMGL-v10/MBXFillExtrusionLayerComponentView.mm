...
- (void)updateProps:(const Props::Shared &)props oldProps:(const Props::Shared &)oldProps
{
  const auto &newProps = *std::static_pointer_cast<const MBXFillExtrusionLayerProps>(props);
    ...
    _view.filter = [MBXFillExtrusionLayerComponentView convertDynamicArrayToArray:&newProps.filter];
    ...
    _view.reactStyle = [MBXFillExtrusionLayerComponentView convertDynamicToDictionary:&newProps.reactStyle];
