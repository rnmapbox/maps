...
fun getAttributionSettings(): AttributionSettings {
    return AttributionSettings.Builder().build()
}
...
fun ScaleBarSettings.Builder.toGenericOrnamentSettings() = object : GenericOrnamentSettings {
...
fun CompassSettings.Builder.toGenericOrnamentSettings() = object : GenericOrnamentSettings {
...
fun LogoSettings.Builder.toGenericOrnamentSettings() = object : GenericOrnamentSettings {
    private var settings = this@toGenericOrnamentSettings
    override fun setHMargins(left: Float?, right: Float?) {
        left?.let { settings.marginLeft = it }
        right?.let { settings.marginRight = it }
...
fun AttributionSettings.Builder.toGenericOrnamentSettings() = object : GenericOrnamentSettings {
    private var settings = this@toGenericOrnamentSettings;
    override fun setHMargins(left: Float?, right: Float?) {
        left?.let { settings.marginLeft = it }
        right?.let { settings.marginRight = it }
