...
public class MBXAndroidTextureMapViewManagerDelegate<T extends View, U extends BaseViewManagerInterface<T> & MBXAndroidTextureMapViewManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
  public MBXAndroidTextureMapViewManagerDelegate(U viewManager) {
    super(viewManager);
  }
  @Override
