...
public class MBXMapViewManagerDelegate<T extends View, U extends BaseViewManagerInterface<T> & MBXMapViewManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
  public MBXMapViewManagerDelegate(U viewManager) {
    super(viewManager);
  }
  @Override
