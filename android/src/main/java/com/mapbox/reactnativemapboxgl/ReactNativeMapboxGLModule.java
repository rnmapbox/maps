...
public class ReactNativeMapboxGLModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void setDirectionAnimated(int direction) {
        aPackage.getManager().setDirection(aPackage.getManager().getMapView(), direction);
    }

    @ReactMethod
    public void setCenterCoordinateAnimated(double latitude, double longitude) {
    ...
    @ReactMethod
    public void setCenterCoordinateZoomLevelAnimated(double latitude, double longitude, double zoom) {
        WritableMap location = Arguments.createMap();
        location.putDouble("latitude", latitude);
        location.putDouble("longitude", longitude);
    ...
    @ReactMethod
    public void setUserTrackingMode(String mode) {
