...
export type Props = LayerPropsCommon & {
   ...
   */
  style: HillshadeLayerStyleProps;
...
class HillshadeLayer extends AbstractLayer<Props, NativeTypeProps> {
  static defaultProps = {
  ...
  render() {
    ...
    return (
      ...
      <RNMBXHillshadeLayerNativeComponent ref={this.setNativeLayer} {...props} />
    );
  }
}
