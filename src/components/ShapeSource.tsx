...
import MBXShapeSourceNativeComponent from '../specs/MBXShapeSourceNativeComponent';
import NativeMBXShapeSourceModule from '../specs/NativeMBXShapeSourceModule';
...
export class ShapeSource extends NativeBridgeComponent(
  ...
  async getClusterExpansionZoom(
    ...
    const res: { data: number } =
      await NativeMBXShapeSourceModule.getClusterExpansionZoom(
        handle,
  ...
  async getClusterLeaves(
    ...
    const res: { data: string } =
      await NativeMBXShapeSourceModule.getClusterLeaves(
        handle,
        JSON.stringify(feature),
        limit,
        offset,
  ...
  async getClusterChildren(feature: number | GeoJSON.Feature) {
    ...
    const res: { data: string } =
      await NativeMBXShapeSourceModule.getClusterChildren(
        handle,
        JSON.stringify(feature),
      );
  ...
  render() {
    ...
    return (
      <MBXShapeSourceNativeComponent {...props}>
        {cloneReactChildrenWithProps(this.props.children, {
          sourceID: this.props.id,
        })}
      </MBXShapeSourceNativeComponent>
    );
  }
}
